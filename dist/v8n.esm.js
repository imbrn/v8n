...
function proxyContextEs5(context) {
  Object.keys(availableRules).forEach(function(prop) {
    context[prop] = function() {
      var newContext = proxyContextEs5(context._clone());
      return newContext
        ._applyRule(availableRules[prop], prop)
        .apply(undefined, arguments);
    };
  });

  Object.keys(customRules).forEach(function(prop) {
    context[prop] = function() {
      var newContext = proxyContextEs5(context._clone());
      return newContext
        ._applyRule(customRules[prop], prop)
        .apply(undefined, arguments);
    };
  });
